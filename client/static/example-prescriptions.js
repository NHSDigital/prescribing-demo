...
function Organization(odsCode, type, name) {
    ...
    this.type = [
        {
            coding: [
                new Coding("urn:oid:2.16.840.1.113883.2.1.3.2.4.17.94", type.code, type.desc)
            ]
        }
    ]
    this.name = name
...
Patient.prototype.setGeneralPractitioner = function (practitioner) {
...
function MedicationRequest(prescriptionIdentifier, prescriptionShortFormIdentifier, medicationCode, quantity, authoredOn) {
    ...
    this.category = {
        coding: new Coding("urn:oid:2.16.840.1.113883.2.1.3.2.4.17.25", "0001")
    }
    this.status = "active"
    this.intent = "order"
...
MedicationRequest.prototype.setRequester = function (practitionerRole) {
    this.requester = {
        reference: "urn:uuid:" + practitionerRole.id
    }
}
MedicationRequest.prototype.setRecorder = function (practitionerRole) {
    this.recorder = {
        reference: "urn:uuid:" + practitionerRole.id
    }
}
...
const medicationRequest1 = new MedicationRequest(
    ...
    shortFormPrescriptionIdentifier1,
...
medicationRequest1.setRequester(practitionerRole1)
medicationRequest1.setRecorder(practitionerRole1)
...
EXAMPLE_PRESCRIPTION_SINGLE_LINE_ITEM.addEntry(new Entry(practitionerRole1))
...
const medicationRequest2a = new MedicationRequest(
    ...
    shortFormPrescriptionIdentifier2,
...
medicationRequest2a.setRequester(practitionerRole2)
medicationRequest2a.setRecorder(practitionerRole2)
...
medicationRequest2b.setRequester(practitionerRole2)
medicationRequest2b.setRecorder(practitionerRole2)
...
medicationRequest2c.setRequester(practitionerRole2)
medicationRequest2c.setRecorder(practitionerRole2)
...
medicationRequest2d.setRequester(practitionerRole2)
medicationRequest2d.setRecorder(practitionerRole2)
...
EXAMPLE_PRESCRIPTION_MULTIPLE_LINE_ITEMS.addEntry(new Entry(practitionerRole2))
